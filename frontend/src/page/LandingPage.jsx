...
const LandingPage = () => {
  ...
  return (
    <div className="overflow-hidden w-screen">
      <div className="z-50 fixed flex left-[30rem]">
        { msgNologin &&
          <CardMsg
      ...
      <div className="h-[300px] md:h-[450px] lg:h-[600px] bg-primary relative lg:pt-16 md:pt-12 pt-8 px-5">
        ...
        <div
          data-aos="fade-up"
          className="h-fit w-fit mb-3 md:mb-5 lg:mb-7 md:w-[600px] lg:w-[800px] border-2 lg:border-r-8 lg:border-b-8 md:border-r-[6px] md:border-b-[6px] border-r-4 border-b-4 rounded-xl text-xs md:text-base lg:text-xl border-secondary shadow-2xl flex flex-col text-center bg-white px-3 py-3 lg:px-12 gap-3 lg:py-7  m-auto relative "
        >
          <img
            src="/softStar.png"
            alt="eror"
            className="absolute -top-7 -left-7 md:-top-12 md:-left-12 md:h-28 h-16"
          />
          <h1 className=" text-lg md:text-2xl lg:text-4xl font-semibold font-lexend">
            Sistem Informasi UKM
          </h1>
          <p>
            Temukan Ruang untuk Mengembangkan Ide dan Bakatmu Platform Digital
            Inovatif yang Mendorong Kreativitas dan Kolaborasi di Kalangan
            Mahasiswa
          </p>
        </div>
        <div className="flex gap-3 md:ml-16 lg:ml-80">
          <Button
            ...
            onClick={() => sethidenRegist(!hidenRegist)}
          >
            Daftar Sekarang
          </Button>
          <Button
            className="bg-primary"
            onClick={() => sethidenLogin(!hidenLogin)}
          >
            Login
          </Button>
        </div>
        <div
          data-aos="fade-left"
          className="h-fit w-64 md:w-80  lg:w-[550px] border-2  lg:border-l-8 lg:border-b-8 md:border-b-[6px] md:border-l-[6px] bg-white rounded-xl border-secondary shadow-2xl absolute right-6 bottom-5 lg:p-7 md:p-5 lg:text-xl md:text-sm hidden md:block "
        >
          <p>
            Selamat datang di Sistem Informasi UKM, <br /> tempat dimana
            semangat kreativitas dan kolaborasi mahasiswa bersatu. Kami
            menyediakan ruang bagi Unit Kegiatan Mahasiswa untuk berbagi ide,
            berkolaborasi,
            <br /> dan mengembangkan potensi mereka secara maksimal.
          </p>
        </div>
      </div>
      {/* UKM Section */}
      <div className="h-[450px] md:h-[540px] lg:h-[650px] border-y border-secondary md:p-5 p-2 flex items-center flex-col">
        ...
        <Button onClick={handleAuthAbout} className="bg-white text-secondary">
          Baca Selengkapnya
        </Button>
      </div>
      {/* Minat Section */}
